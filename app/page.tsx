      ...
      <main className="flex-1">
        ...
        <section className="relative py-16 md:py-24 overflow-hidden bg-gradient-to-br from-navy-900 via-navy-950 to-purple-950">
          ...
          <style jsx>{`
            ...
            .locafy-logo-float { animation: locafyLogoFloat 8s ease-in-out infinite; }
          `}</style>
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            {/* Locafy Logo in 3D Space - Positioned to the left of AI Fusion logo */}
            <div className="absolute top-1/2 left-1/4 transform -translate-x-1/2 -translate-y-1/2 locafy-logo-float z-15">
              <div className="relative group">
                <div className="bg-white/90 rounded-xl p-2 backdrop-blur-sm shadow-2xl transform transition-transform group-hover:scale-110">
                  <img
                    src="/images/locafy-logo.png"
                    alt="Locafy Logo in 3D space"
                    className="w-24 h-auto md:w-28 md:h-auto lg:w-32 lg:h-auto object-contain"
                    style={{
                ...
                <div
                  className="absolute -top-1 -left-1 w-2 h-2 bg-green-400 rounded-full neural-glow shadow-lg"
                ...
                ></div>
                <div
                  className="absolute -bottom-1 -right-1 w-2 h-2 bg-cyan-400 rounded-full neural-glow shadow-lg"
                  style={{ animationDelay: "2s" }}
                ></div>

                {/* Connection lines */}
                <div className="absolute top-1/2 -left-8 w-8 h-0.5 bg-gradient-to-r from-green-400/60 to-transparent neural-glow"></div>
                <div className="absolute top-1/2 -right-8 w-8 h-0.5 bg-gradient-to-l from-blue-400/60 to-transparent neural-glow"></div>
                <div className="absolute -top-8 left-1/2 h-8 w-0.5 bg-gradient-to-b from-purple-400/60 to-transparent neural-glow"></div>
                <div className="absolute -bottom-8 left-1/2 h-8 w-0.5 bg-gradient-to-t from-cyan-400/60 to-transparent neural-glow"></div>
              </div>
            </div>
