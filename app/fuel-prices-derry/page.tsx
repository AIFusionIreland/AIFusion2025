...
export default function FuelPricesDerryPage() {
  ...
  useEffect(() => {
    async function fetchPrices() {
      try {
        // Fetch each fuel type separately with filtered queries to get all GBP prices
        const [dieselRes, petrolRes, heatingOilRes] = await Promise.all([
          fetch("https://fuel-the-gap.replit.app/api/prices?currency=GBP&fuelType=diesel"),
          fetch("https://fuel-the-gap.replit.app/api/prices?currency=GBP&fuelType=petrol"),
          fetch("https://fuel-the-gap.replit.app/api/prices?currency=GBP&fuelType=home_heating_oil")
        ])
        ...
        if (allDates.length > 0) {
          ...
          setLastUpdated(mostRecent.toLocaleDateString('en-GB', { 
            weekday: 'long', 
            year: 'numeric', 
            month: 'long', 
            day: 'numeric',
  ...
  return (
    <div className="min-h-screen bg-navy-950">
      ...
      {/* Hero Section */}
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-navy-900 via-navy-950 to-blue-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4 text-balance">
            Cheapest Fuel Prices in Derry Today
          </h1>
          <p className="text-lg md:text-xl text-gray-300 mb-2">
            Diesel, Petrol &amp; Heating Oil
          </p>
          <p className="text-gray-400 max-w-2xl mx-auto mb-6">
            Fuel prices vary across Derry. Save <strong className="text-blue-400">£5–£15 per fill</strong> by checking before you buy.
          </p>
          {lastUpdated && (
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-navy-900/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-navy-900 border-blue-500/30">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mb-3">
                      With a 60L tank and 10p per litre savings:
                    </p>
                    <p className="text-3xl font-bold text-blue-400">£6.00 saved</p>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-blue-400">£312+ saved</p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-900/30 to-navy-950">
        <div className="max-w-4xl mx-auto text-center">
          <Badge className="bg-blue-500/20 text-blue-400 border-blue-500/30 mb-4">
            Free App
          </Badge>
          ...
          <p className="text-gray-300 max-w-2xl mx-auto mb-8">
            The free app for finding the cheapest fuel prices in Derry and Donegal. Community-powered, always up-to-date.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl mx-auto mb-8">
            ...
            <div className="bg-navy-900/80 rounded-lg p-4 border border-navy-700">
              <Flame className="w-6 h-6 text-blue-400 mx-auto mb-2" />
              <p className="text-sm text-gray-300">Track heating oil prices</p>
            </div>
            <div className="bg-navy-900/80 rounded-lg p-4 border border-navy-700">
              <PiggyBank className="w-6 h-6 text-blue-400 mx-auto mb-2" />
          ...
          <div className="bg-blue-500/20 border border-blue-500/30 rounded-lg p-4 max-w-md mx-auto mb-8">
            <p className="text-blue-400 font-semibold">Check before every fill!</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Fuel delivery costs vary based on distance from depots and order volumes.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-full bg-navy-800 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Prices can change throughout the week. Check Fuel the Gap for the latest updates.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 border-t border-navy-800">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gray-400 mb-4">
            Fuel the Gap is a community app developed by <Link href="/" className="text-blue-400 hover:underline">AI Fusion</Link> to help local residents find the best fuel prices.
          </p>
