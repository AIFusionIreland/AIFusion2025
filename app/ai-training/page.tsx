  ...
  return (
    <div className="flex flex-col min-h-screen bg-navy-975">
      ...
      <main className="flex-1">
            ...
            <div className="text-center">
              <Dialog>
                <DialogTrigger asChild>
                  <div className="rounded-2xl overflow-hidden shadow-lg cursor-pointer transition-transform hover:scale-[1.02] max-w-4xl mx-auto">
                    <img
                ...
                <DialogContent className="sm:max-w-[625px] bg-navy-900 border-navy-800">
                  ...
                  <div className="space-y-4">
                    <p className="text-gray-200">
                      ...
                      individuals, small businesses, entrepreneurs, and professionals. Our mission is simple: to make AI
                      accessible, practical, and impactful, no matter your technical expertise.
                    </p>
                    <p className="text-gray-200">
                      ...
                      create engaging content, or solve everyday challenges with AI-powered hacks, we provide the tools
                      and knowledge to help you thrive.
                    </p>
                    <p className="text-gray-200">
                  ...
                  <div className="mt-6 flex justify-center">
                    <Button
                      className="rounded-full px-6 py-6 bg-purple-600 hover:bg-purple-700 text-white"
                      onClick={() => {
        ...
        {/* CTA Section */}
        <section className="py-24 bg-gradient-to-br from-purple-600 to-navy-700 text-white">
          <div className="container px-4 md:px-6 max-w-4xl">
            <div className="text-center space-y-8">
              <h2 className="text-3xl md:text-4xl font-medium tracking-tight">Ready to Start Your AI Journey?</h2>
              <div className="flex justify-center">
                <Button
                  className="rounded-full px-8 py-6 bg-white text-navy-800 hover:bg-gray-100 text-lg font-semibold"
